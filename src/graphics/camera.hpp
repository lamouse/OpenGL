...
class Camera {
    public:
        ...
        auto GetViewMatrix() const -> glm::mat4 { return glm::lookAt(Position, Position + Front, Up); }
    ...
    private:
        ...
        void updateCameraVectors() {
            ...
            Right = glm::normalize(glm::cross(
                Front, WorldUp));  // normalize the vectors, because their length gets closer to 0
